package org.appslapp.AppsLappServer.business.Constants;

public class EmailString {
    public static final String APPSLAPP_GMAIL_COM = "appslappmanagement@gmail.com";
    public static final String SENDER_NAME = "AppsLapp";
    public static final String NEW_ACCOUNT_SUBJECT = "Registracia";
    public static final String NEW_ACCOUNT_CONTENT = "<!DOCTYPE html>\n" +
            "\n" +
    ...
    public static final String PASSWORD_RESET_SUBJECT = "Resetovanie hesla";
    public static final String PASSWORD_RESET_CONTENT = "<!DOCTYPE html>\n" +
            "\n" +
            "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
            "\n" +
            "<head>\n" +
