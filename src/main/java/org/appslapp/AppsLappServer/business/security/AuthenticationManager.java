...
public class AuthenticationManager extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().configurationSource(request -> config)
                ...
                .mvcMatchers("/api/exercise/{*id}/getHint").hasAnyAuthority("LABMASTER", "PUPIL")
                .mvcMatchers("/api/lab/student/**").hasAnyAuthority("LABMASTER", "PUPIL")
                .mvcMatchers("/api/lab/**").hasAnyAuthority("LABMASTER", "PUPIL")
                .mvcMatchers("/api/exercise/**").hasAnyAuthority("LABMASTER", "PUPIL")
                .mvcMatchers("/api/student/**").hasAnyAuthority("LABMASTER", "PUPIL")
                .anyRequest().denyAll()
                .and()
                .csrf().disable()
                .httpBasic()
